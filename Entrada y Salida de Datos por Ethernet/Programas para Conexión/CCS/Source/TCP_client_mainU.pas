...
begin
  ...
  Port.readOnly := FALSE;
  IncommingData.Lines.add(formatdatetime('HH:NN:SS.zz', now) + #9 +
                               'Disconnected: ' + TcpClient1.RemoteHost +
                               ':' + TcpClient1.RemotePort);
end;

{-------------------------------------------------------------*
* TcpClient1Error:                                            *
*   On a winsock error place the error code in the data field *
*-------------------------------------------------------------}
...
{------------------------------------------------------------*
* Timer1Timer event:                                         *
*   Every so often check for new data                        *
*------------------------------------------------------------}
...
{----------------------------------------------------------*
* DoSocketClosed:                                          *
*   When the socket is closed make sure we disconnect      *
*----------------------------------------------------------}
...
{----------------------------------------------------------*
* FormClose Event:                                         *
*   When the form is closed make sure everything is        *
*   disconnected                                           *
*----------------------------------------------------------}
