...
// select "PIC18 Config Settings" in the Language Tools section.
 	...
 	#if defined(__18F4550) || defined(__18F4553) || defined(__18F2550) || defined(__18F2455)
...
void main(void)
{   
    ADCON1 = 0x0F;			//Need to make sure RA1 can be used as a digital input pin
 	//	TRISAbits.TRISA1 = 1;	//No need to explicitly do this since reset state is = 1 already.
